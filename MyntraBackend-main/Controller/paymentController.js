  ...
  try {
    ...
    const payload = {
      ...
      customer: {
          ...
          taxId: `Order ID: ${paymentDetails.order_id}`, // Optional.
      },
      invoice: {
          number: `${paymentDetails.acquirer_data.authentication_reference_number}`, // String or number.
          date: paymentDate, // Default is current date.
